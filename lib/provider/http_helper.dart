...
class HttpHelper {
  final String urlKey = "40be8d96983b438acea76017aedaca81";
  ...
  Future<List> findMovies(String title) async {
    ...
    http.Response result = await http.get(Uri.parse('$urlBase/movie/upcoming?api_key=$urlKey&language=en-US&page=1'));
